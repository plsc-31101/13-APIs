...
Let's begin by getting an individual API key. Remember, this key is unique to you, and you'll only need to request a key the first time you ever use a new API. Click [here](https://developer.nytimes.com/get-started) and follow the instructions to request a key. (Call your "app" *ps31101* or something similar.)

Next, let's go ahead and store the these values as variables:
