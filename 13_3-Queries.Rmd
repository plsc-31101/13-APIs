...
Let's begin by getting an individual API key. Remember, this key is unique to you, and you'll only need to request a key the first time you ever use a new API. Click [here](https://developer.nytimes.com/get-started) and follow the isntructions to request a key.
